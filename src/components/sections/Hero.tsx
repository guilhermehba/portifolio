        ...
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
          <div className="flex flex-col gap-6">
            ...
            >
              ...
              mostrar seus serviços, facilitar vendas e crescer com mais confiança.
            </motion.p>
            ...
            >
              <a
                href="https://wa.me/5563992706543"
                target="_blank"
                rel="noreferrer"
          ...
          >
            ...
            <div className="mt-6 space-y-5">
              <div className="rounded-3xl border border-slate-800 bg-slate-900/85 p-5">
                <div className="flex items-center justify-between text-sm text-slate-400">
                  <span>Demos funcionais</span>
                  <span className="font-semibold text-slate-100">2 online</span>
                </div>
            ...
            <div className="mt-6 grid gap-4 sm:grid-cols-2">
              <div className="rounded-3xl border border-slate-800 bg-slate-950/90 p-4 text-sm text-slate-300">
                <p className="font-semibold text-white">Landing real</p>
                <p className="mt-2">Projeto de estética em produção.</p>
              </div>

              <div className="rounded-3xl border border-slate-800 bg-slate-950/90 p-4 text-sm text-slate-300">
                <p className="font-semibold text-white">Catálogo smart</p>
                <p className="mt-2">Demo funcional no PythonAnywhere.</p>
              </div>
            </div>
          </motion.div>
        </div>
